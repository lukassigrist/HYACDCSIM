...
SUBROUTINE DDCGRD(I_MACH,I_SLOT)
	...
	CASE (1) ! INITIAL STATE
		...
		!	ALLOCATE(CONVERTER_ACDC_BUS_GLOBAL(NDCBUS,2,2))
		!	aux_var_global = 7	
		!END IF
        ...
        !CONVERTER_ACDC_BUS_GLOBAL(:,:,IDGRID_num) = CONVERTER_ACDC_BUS
        DO i = 1, NDCBUS
	...
	CASE (3) 
        ...
        !READ(IDGRID, *) IDGRID_num ! Convert char to number
		!CONVERTER_ACDC_BUS = CONVERTER_ACDC_BUS_GLOBAL(:,:,IDGRID_num)
		DO i = 1, NDCBUS
