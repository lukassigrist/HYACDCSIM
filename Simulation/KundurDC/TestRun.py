...
ierr, ival = psspy.mdlind(7,"""14""",'GEN','VAR') 
I_VAR_SVSCON_7 = ival
ierr, ival = psspy.mdlind(9,"""14""",'GEN','VAR') 
I_VAR_SVSCON_9 = ival
ierr, ival = psspy.mdlind(7,"""14""",'GOV','STATE') 
I_STATE_DCGRID_1 = ival

psspy.state_channel([-1, I_STATE_DCGRID_1], r"VDC1_DC1")
psspy.state_channel([-1, I_STATE_DCGRID_1+1], r"VDC2_DC1")
...
psspy.var_channel([-1, I_VAR_SVSCON_7+25], r"PDC1_DC1")
psspy.var_channel([-1, I_VAR_SVSCON_9+25], r"PDC2_DC1")
...
for imach in v_idxvdcmtdc1:
    v_vdc = chandata[imach+1]
    axs.plot(v_t,v_vdc,linewidth=2)
    l_legend1.append(chanid.values()[imach+1]) 
axs.set_ylabel("Vdc (pu)")
